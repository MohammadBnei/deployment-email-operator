...
type DeploymentMonitorSpec struct {
	...
	// foo is an example field of DeploymentMonitor. Edit deploymentmonitor_types.go to remove/update
	// +optional
...
type DeploymentMonitorStatus struct {
	...
	// conditions represent the current state of the DeploymentMonitor resource.
...
type DeploymentMonitor struct {
	...
	// +optional
	Status DeploymentMonitorStatus `json:"status,omitempty,omitzero"`
}
